...
@component('chief::back._layouts._partials.header')
    ...
    <div class="inline-group-s">
        ...
        <button data-submit-form="updateForm" type="button" class="btn btn-primary">@lang('chief::managers.save_changes')</button>
    ...
    <div>
        ...
        <form id="updateForm" method="POST" action="{{ $manager->route('update') }}" enctype="multipart/form-data" role="form">
            ...
            <div class="stack text-right">
                <button type="submit" class="btn btn-primary"> @lang('chief::managers.save_changes')</button>
            </div>
