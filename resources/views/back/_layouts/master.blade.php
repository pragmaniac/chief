...
<main id="main" class="bg-grey-lightest min-h-screen">
    ...
    <section id="content" class="container relative">
        <div v-cloak class="v-loading inset-xl text-center bg-grey-lightest" style="position: absolute; top: 0;left: 0;z-index: 99;width: 100%;height: 100%;">@lang('chief::components.loading')</div>
